"""Module to test API"""
from tests.base import (TestingClass,test_user_data, test_sign_in,wrong_test_user_data, wrong_test_sign_in, test_wrong_sign_in)
...
class all_orders_test(TestingClass):
    ...
    def test_get_all_entries(self):
        ...
        test_create_order(self.test_user)
        response = test_get_an_order(self.test_user)
